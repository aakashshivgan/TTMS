...
public  class Dashboard extends JFrame implements ActionListener {
    ...
    String username;
      ...
      Dashboard(String username){
          ...
          ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("travel/management/system/icons/dashboard.png"));//Dashboard editing 
                  ...
                  l2.setBounds(0,0,70,70);
                   ...
                   b1.setMargin(new Insets(0,0,0,90));
                   b1.setBounds(0,0,300,50);
                   b1.addActionListener(this);
                   p2.add(b1);
                   
                   b2 = new JButton("Update Add Personal Details");
                   ...
                   b5.setMargin(new Insets(0,0,0,138));
                   ...
                   b6.setMargin(new Insets(0,0,0,145));
                   b6.setBounds(0,250,300,50);
                   p2.add(b6);
                   
                   b7 = new JButton("Add Personal Details");
                   ...
                   b10.setMargin(new Insets(0,0,0,165));
                   ...
                   b13.setMargin(new Insets(0,0,0,175));
                   ...
                   b14.setMargin(new Insets(0,0,0,185));
                   ...
                   b15.setMargin(new Insets(0,0,0,210));
          ...
          ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("travel/management/system/icons/home.jpg"));
                  ...
                  l4.setFont(new Font("Tahoma",Font.BOLD,40));
                  l1.add(l4);
