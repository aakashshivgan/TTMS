...
public class ForgotPassword extends JFrame implements ActionListener{
    ...
    ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("travel/management/system/icons/password.png"));
   ...
   p.add(b1);
    ...
    t4 = new JTextField();
    t4.setBounds(230,140,150,25);
    p.add(t4);
    
   b2= new JButton("Retrieve");
   b2.setBackground(Color.GRAY);
   b2.setForeground(Color.WHITE);
   b2.setBounds(390, 140, 100, 25);
